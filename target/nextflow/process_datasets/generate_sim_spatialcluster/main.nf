// generate_sim_spatialcluster build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/process_datasets/generate_sim_spatialcluster/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "input_sp_sim" = $( if [ ! -z ${VIASH_PAR_INPUT_SP_SIM+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SP_SIM" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_simulators/process_datasets/generate_sim_spatialcluster",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
