...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/process_datasets/sc_features/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "sc_species" = $( if [ ! -z ${VIASH_PAR_SC_SPECIES+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_SC_SPECIES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
