...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/process_datasets/convert/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  "input_sc" = $( if [ ! -z ${VIASH_PAR_INPUT_SC+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SC" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "input_sp" = $( if [ ! -z ${VIASH_PAR_INPUT_SP+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SP" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "output_sc" = $( if [ ! -z ${VIASH_PAR_OUTPUT_SC+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_OUTPUT_SC" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/process_datasets/convert",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
