...
meta = [
  ...
  "description" : "four downstream analytical tasks will add into the real data",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/process_datasets/downstream/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/process_datasets/downstream",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/process_datasets/downstream",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
