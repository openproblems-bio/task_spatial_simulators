// ks_statistic_sc_features build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/metrics/ks_statistic_sc_features/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/ks_statistic_sc_features",
    "viash_version" : "0.9.0-RC7",
    "git_commit" : "5021f0761f04b0ad22e4f81f91d083cbfc88ca85",
...
par <- list(
  "input_spatial_dataset" = $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_DATASET+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SPATIAL_DATASET" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "input_singlecell_dataset" = $( if [ ! -z ${VIASH_PAR_INPUT_SINGLECELL_DATASET+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SINGLECELL_DATASET" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "input_simulated_dataset" = $( if [ ! -z ${VIASH_PAR_INPUT_SIMULATED_DATASET+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SIMULATED_DATASET" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/metrics/ks_statistic_sc_features",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
