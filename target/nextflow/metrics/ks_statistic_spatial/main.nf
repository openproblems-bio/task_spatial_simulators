// ks_statistic_spatial build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/metrics/ks_statistic_spatial/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  'input_spatial_dataset': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_DATASET+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIAL_DATASET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_singlecell_dataset': $( if [ ! -z ${VIASH_PAR_INPUT_SINGLECELL_DATASET+x} ]; then echo "r'${VIASH_PAR_INPUT_SINGLECELL_DATASET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_simulated_dataset': $( if [ ! -z ${VIASH_PAR_INPUT_SIMULATED_DATASET+x} ]; then echo "r'${VIASH_PAR_INPUT_SIMULATED_DATASET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/metrics/ks_statistic_spatial",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
