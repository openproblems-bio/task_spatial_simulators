...
meta = [
      ...
      "arguments" : [
        {
          ...
          "example" : [
            "resources_test/common/mobnew/dataset_sp.h5ad"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/metrics/my_metric/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_simulators/metrics/my_metric",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
