...
meta = [
  ...
  "description" : "A positive control method. \n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/control_methods/positive/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/control_methods/positive",
    "viash_version" : "0.9.0",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_simulators/control_methods/positive",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
