...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/methods/scdesign3_poisson/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "family" = $( if [ ! -z ${VIASH_PAR_FAMILY+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_FAMILY" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "usebam" = $( if [ ! -z ${VIASH_PAR_USEBAM+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_USEBAM" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_simulators/methods/scdesign3_poisson",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
