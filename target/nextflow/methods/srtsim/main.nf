...
meta = [
  ...
  "info" : {
    ...
    "description" : "A key benefit of srtsim is its ability to maintain location-wise and gene-wise SRT count properties and \npreserve spatial expression patterns, enabling evaluation of SRT method performance using synthetic data. \n",
    "reference" : "10.1186/s13059-023-02879-z",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/methods/srtsim/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/methods/srtsim",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
