...
meta = [
  ...
  "info" : {
    ...
    "description" : "ZINB-WaVE is a general and flexible zero-inflated negative binomial model, which leads to low-dimensional representations \nof the data that account for zero inflation (dropouts), over-dispersion, and the count nature of the data.\n",
    "reference" : "10.1038/s41467-017-02554-5",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/methods/zinbwave/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/methods/zinbwave",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
