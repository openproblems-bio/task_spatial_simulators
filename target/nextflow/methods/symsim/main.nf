...
meta = [
  ...
  "info" : {
    ...
    "description" : "SymSim is a simulator for modeling single-cell RNA-Seq data, accounting for three primary sources of variation: intrinsic transcription noise, extrinsic variation from different cell states, \nand technical variation from measurement noise and bias.\n",
    "reference" : "10.1038/s41467-019-10500-w",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_simulators/task_spatial_simulators/src/methods/symsim/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "base" = $( if [ ! -z ${VIASH_PAR_BASE+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_BASE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io.",
    "image" : "openproblems-bio/task_spatial_simulators/methods/symsim",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
