...
param_list:
  ...
  - id: spatialsimbench/brain
    input_sc: "$CACHE_DIR/MBRAIN_sc.rds"
    input_sp: "$CACHE_DIR/BRAIN.rds"
    dataset_id: spatialsimbench/brain
    dataset_name: Brain
  ...
  - id: spatialsimbench/fibrosarcoma
    input_sc: "$CACHE_DIR/MCATUMOR_sc.rds"
    input_sp: "$CACHE_DIR/MCATUMOR.rds"
    dataset_id: spatialsimbench/fibrosarcoma
  ...
  - id: spatialsimbench/gastrulation
    input_sc: "$CACHE_DIR/MGASTRULA_sc.rds"
    input_sp: "$CACHE_DIR/MGASTRULA.rds"
    dataset_id: spatialsimbench/gastrulation
  ...
  - id: spatialsimbench/olfactorybulb
    input_sc: "$CACHE_DIR/MOBNEW_sc.rds"
    input_sp: "$CACHE_DIR/MOBNEW.rds"
    dataset_id: spatialsimbench/olfactorybulb
  ...
  - id: spatialsimbench/hindlimbmuscle
    input_sc: "$CACHE_DIR/MUSCLE_sc.rds"
    input_sp: "$CACHE_DIR/MUSCLE.rds"
    dataset_id: spatialsimbench/hindlimbmuscle
...
publish_dir: "resources/spatial_simulators/datasets"
